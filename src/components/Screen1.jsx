...
export default function Screen1({ onNext }) {
    return (
        <motion.div
            ...
            >
                <h1 className="text-4xl md:text-5xl font-bold text-white leading-tight">I have a little secret for you...my love</h1>
                <p className="text-2xl md:text-3xl text-purple-200 font-light">And trust me... only YOU deserve this masso ✨</p>
            </motion.div>
